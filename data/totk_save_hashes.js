// 王国之泪(ToTK) 存档收集数据 hash 表 —— 提取自 marcrobledo/savegame-editors (MIT)
// 由 zelda-totk.completism.js 的 CompletismHashes 完整提取，未经修改
// 依赖 murmurHash3.x86.hash32 与全局 hash() 函数

function hash(hashText){
	return murmurHash3.x86.hash32(hashText);
}
